  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="lg:hidden sticky top-0 z-40 bg-white/80 backdrop-blur-sm border-b p-4 flex items-center justify-between">
        ...
        >
          {!isNavOpen ? <Menu className="w-5 h-5" /> : <X className="w-5 h-5" />}
          Menu
        </button>
        {/*<button
      ...
      <div className="relative z-20 max-w-screen-2xl mx-auto grid grid-cols-1 lg:grid-cols-12">
        ...
        <aside
          className={`fixed left-0 right-0 bottom-0 top-[69px] z-50 bg-white overflow-y-auto lg:bg-transparent lg:static lg:block lg:col-span-3 lg:border-r ${isNavOpen ? 'block' : 'hidden'}`}
        >
        ...
        {/* Center - Main Content */}
        <main className="col-span-1 lg:col-span-8 p-8">{children}</main>
