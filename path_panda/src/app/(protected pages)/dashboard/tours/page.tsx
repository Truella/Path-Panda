      ...
      <div className="flex flex-col min-h-screen bg-white">
        ...
        <main className="flex-1 overflow-auto p-8">
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 max-w-2xl mx-auto">
            <h3 className="text-red-800 font-semibold mb-2">Failed to load tours</h3>
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-1 overflow-auto">
        {/* Page Header */}
        <div className="border-b border-gray-200 bg-white sticky top-8 z-10 mb-8">
          <div className="flex items-center justify-between px-8 py-6">
            <div>
              <h1 className="text-3xl font-bold text-black">My Tours</h1>
              <p className="text-gray-600 mt-1">
                Create and manage your onboarding tours
                {!isLoading && tours && ` • ${tours.length} ${tours.length === 1 ? 'tour' : 'tours'}`}
              </p>
            </div>
            <button
              onClick={() => router.push("/dashboard/tours/new")}
              className="flex items-center gap-2 bg-black text-white px-6 py-2 rounded-lg hover:bg-gray-800 transition font-medium"
            >
        ...
        <div className="p-8">
          ...
          {!isLoading && tours && tours.length === 0 && (
            <div className="text-center py-12 border border-gray-200 rounded-lg">
              ...
              <h3 className="text-xl font-semibold text-black mb-2">No tours yet</h3>
          ...
          {!isLoading && tours && tours.length > 0 && filteredTours.length === 0 && (
            <div className="text-center py-12 border border-gray-200 rounded-lg">
              <Search className="w-12 h-12 text-gray-400 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-black mb-2">No tours found</h3>
              <p className="text-gray-600 mb-4">
                No tours match &quot;{searchTerm}&quot;. Try adjusting your search.
              </p>
              <button
